 ...
 * 
 */
public class GetTaskHistoryResult extends AbstractSimpleResult<List<TaskActivity>> {

	protected GetTaskHistoryResult() {
		super();
	}

	public GetTaskHistoryResult(List<TaskActivity> value) {
		super(value);
	}
