 ...
 * 
 */
public class ListAttachmentsResult extends AbstractSimpleResult<List<Attachment>> {

	protected ListAttachmentsResult() {
		super();
	}

	public ListAttachmentsResult(List<Attachment> value) {
		super(value);
	}
