...
/**
 * Flagexclusions generated by hbm2java
 */
@Entity
@Table(name = "flagexclusions")
@SuppressWarnings("serial")
public class Flagexclusions implements java.io.Serializable {

	private FlagexclusionsId id;
	private Flagtypes flagtypes;
	private Product products;
	private Component components;

	public Flagexclusions() {
	}
	...
	public FlagexclusionsId getId() {
		return this.id;
	}

	public void setId(FlagexclusionsId id) {
		this.id = id;
	}
