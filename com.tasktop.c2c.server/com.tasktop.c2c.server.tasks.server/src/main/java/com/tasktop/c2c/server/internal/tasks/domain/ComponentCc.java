...
/**
 * ComponentCc generated by hbm2java
 */
@Entity
@Table(name = "component_cc", uniqueConstraints = @UniqueConstraint(columnNames = { "component_id", "user_id" }))
@SuppressWarnings("serial")
public class ComponentCc implements java.io.Serializable {

	private ComponentCcId id;
	...
	public ComponentCcId getId() {
		return this.id;
	}

	public void setId(ComponentCcId id) {
		this.id = id;
	}
