 ...
 * 
 */
public class CreateCustomFieldAction implements Action<CreateCustomFieldResult>, WriteAction {

	private String projectId;
	private FieldDescriptor customField;

	public CreateCustomFieldAction(String projectId, FieldDescriptor customField) {
		this.projectId = projectId;
		this.customField = customField;
	}

	protected CreateCustomFieldAction() {
