 ...
 * 
 */
public class UpdateCustomFieldResult extends AbstractSimpleResult<FieldDescriptor> {

	protected UpdateCustomFieldResult() {
		super();
	}

	public UpdateCustomFieldResult(FieldDescriptor value) {
		super(value);
	}
