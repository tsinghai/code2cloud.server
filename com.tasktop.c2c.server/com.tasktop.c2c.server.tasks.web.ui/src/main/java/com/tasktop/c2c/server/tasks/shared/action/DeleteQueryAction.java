 ...
 * 
 */
public class DeleteQueryAction implements Action<DeleteQueryResult>, WriteAction {

	private String projectId;
	private SavedTaskQuery query;

	public DeleteQueryAction(String projectId, SavedTaskQuery query) {
		this.projectId = projectId;
		this.query = query;
	}

	protected DeleteQueryAction() {
