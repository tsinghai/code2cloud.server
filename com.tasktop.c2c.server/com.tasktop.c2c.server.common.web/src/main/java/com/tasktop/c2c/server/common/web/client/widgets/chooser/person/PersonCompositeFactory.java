 ...
 * 
 */
public class PersonCompositeFactory extends ValueCompositeFactory<Person> {

	@Override
	public AbstractValueComposite<Person> getComposite(AbstractValueChooser<Person> valueChooser, Person origin) {
		PersonValueComposite valueComposite = new PersonValueComposite(valueChooser);
