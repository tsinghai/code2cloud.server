...
@Ignore
@Service
public class TestPublicKeyAuthenticationService implements PublicKeyAuthenticationService {
	...
	public static void authorize(String username, String[] roles) {
		authorizations.put(username, createAuthenticationToken(username, roles));
	}
