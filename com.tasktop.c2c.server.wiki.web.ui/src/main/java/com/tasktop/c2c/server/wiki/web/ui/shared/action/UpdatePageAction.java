 ...
 * 
 */
public class UpdatePageAction implements Action<UpdatePageResult>, WriteAction {

	private String projectId;
	private Page page;

	public UpdatePageAction(String projectId, Page page) {
		this.projectId = projectId;
		this.page = page;
	}

	protected UpdatePageAction() {
