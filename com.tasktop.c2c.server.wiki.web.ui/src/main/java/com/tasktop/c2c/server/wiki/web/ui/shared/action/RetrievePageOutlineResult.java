 ...
 * 
 */
public class RetrievePageOutlineResult extends AbstractSimpleResult<PageOutline> {

	protected RetrievePageOutlineResult() {
		super();
	}

	public RetrievePageOutlineResult(PageOutline value) {
		super(value);
	}
